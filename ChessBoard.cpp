    ...
    : QMainWindow(parent)
{
    ...
    this->setWindowIcon(QIcon("../QT_Chess/images/ChineseChess.ico"));
    ...
    choiceBox->move(520+30,Grid_Width*4+20);
...
void ChessBoard::drawBoard(QPainter& painter){
    painter.drawPixmap(0,20,521,577,QPixmap("../QT_Chess/images/666.JPG"));
}
...
void ChessBoard::drawChess(QPainter& painter){
        for(int i=51;i<=203;i++){
            ...
            case 0:
                break;
            case 8:
                painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/RR.GIF"));
                break;
            case 9:
                painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/RN.GIF"));
                break;
            case 10:
                painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/RC.GIF"));
                break;
            case 11:
                painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/RB.GIF"));
                break;
            case 12:
                painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/RA.GIF"));
                break;
            case 13:
                painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/RP.GIF"));
                break;
            case 14:
                painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/RK.GIF"));
                break;
            case 16:
                painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/BR.GIF"));
                break;
            case 17:
                painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/BN.GIF"));
                break;
            case 18:
                painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/BC.GIF"));
                break;
            case 19:
                painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/BB.GIF"));
                break;
            case 20:
                painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/BA.GIF"));
                break;
            case 21:
                painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/BP.GIF"));
                break;
            case 22:
                painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/BK.GIF"));
                break;
            }
        }
}
...
void ChessBoard::drawSelectChess(QPainter &painter){
    ...
    if(selectId!=-1){
        ...
        switch (chessType) {
        case 8:
            painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/RRS.GIF"));
            break;
        case 9:
            painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/RNS.GIF"));
            break;
        case 10:
            painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/RCS.GIF"));
            break;
        case 11:
            painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/RBS.GIF"));
            break;
        case 12:
            painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/RAS.GIF"));
            break;
        case 13:
            painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/RPS.GIF"));
            break;
        case 14:
            painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/RKS.GIF"));
            break;
        case 16:
            painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/BRS.GIF"));
            break;
        case 17:
            painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/BNS.GIF"));
            break;
        case 18:
            painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/BCS.GIF"));
            break;
        case 19:
            painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/BBS.GIF"));
            break;
        case 20:
            painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/BAS.GIF"));
            break;
        case 21:
            painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/BPS.GIF"));
            break;
        case 22:
            painter.drawPixmap(X,Y,Radius*2,Radius*2,QPixmap("../QT_Chess/images/WOOD/BKS.GIF"));
            break;
        }
    }
...
void ChessBoard::manGo(QMouseEvent* event){
    ...
    if(!getRowCol(pt,boardPosition)){   //如果点到棋盘外
        return;
    }
    if(selectId==-1&&Board[boardPosition]!=0){  //第一次点击
        selectId=PiecesInBoard[boardPosition];  //第一次选择的ID=棋牌上所在位置棋子的ID
        if(isRedTurn&&(selectId&32)){
            selectId=-1;    //第一次点击,但不是己方走起
            return;
        }else if(!isRedTurn&&(selectId&16)){
            selectId=-1;    //第一次点击,但点到对面棋子
            return;
        }

    }else if(selectId!=-1 && (((selectId&16)!=0&&(PiecesInBoard[boardPosition]&16)!=0)  //第二次点击(走棋)
        ...
        if(MC->Check(!isRedTurn) && Pieces[31]!=0 && Pieces[47]!=0){
            ...
            if(step->Dst_PiecesId!=0){
                Pieces[step->Dst_PiecesId]=step->Dst_Position;  //悔棋
            }
            AllMovedSteps.removeLast(); //Qvector数组，返回上一个
            showStepsArea->undo();
            delete step;
            step=nullptr;
            isRedTurn=!isRedTurn;
